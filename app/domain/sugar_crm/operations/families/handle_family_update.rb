  ...
  module Operations
    module Families
      ...
      class HandleFamilyUpdate
        ...
        require File.join(Rails.root, 'app', 'operations', 'transformers', 'family_to',
                          'family_to_account_and_contacts')
        require 'dry/monads'
        ...
        def call(family_payload)
          ...
          yield validate_contacts_and_accounts(initialized_contacts_and_accounts)
        end
