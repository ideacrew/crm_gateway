...
RSpec.describe SugarCRM::Operations::FamilyUpsert do
      ...
      family_members: [
        {
          ...
          person: {
            ...
            person_relationships: [
              ...
              {
                relative: {
                  hbx_id: '39543c3271b444f79a9c727f39b48f0c',
                  first_name: 'John',
                  middle_name: nil,
                  last_name: 'Smith2',
                  ssn: '701846563',
                  no_ssn: false,
                  dob: Date.today - 15.years,
                  gender: 'male'
                },
                kind: 'spouse'
              }
        ...
        },
        {
          ...
          person: {
            ...
            person_demographics: {
              ssn: '701846563',
              no_ssn: false, gender:
                'male', dob: Date.today - 18.years,
              date_of_death: nil, dob_check: nil,
              is_incarcerated: true, ethnicity: nil,
              race: nil, tribal_id: nil, language_code: nil
            },
            person_health: { is_tobacco_user: 'unknown', is_physically_disabled: nil },
            no_dc_address: false, no_dc_address_reason: nil, is_homeless: false, is_temporarily_out_of_state: false,
            age_off_excluded: false, is_applying_for_assistance: nil, is_active: true, is_disabled: nil, person_relationships: [],
            consumer_role: { five_year_bar: false, requested_coverage_start_date: Date.today,
  ...
  describe '#find_contacts_by_account' do
    ...
    let(:contacts) do
      contact
      contacts = SugarCRM::Services::Connection.new.find_contacts_by_account(
        account_id
      )
      contacts['records']
    end
  ...
  describe '#update_existing_contact' do
    ...
    let(:contact_id) do
      contact = SugarCRM::Services::Connection.new.create_contact_for_account(
        account_id: account_id,
        hbx_id: '123',
        first_name: 'John',
        last_name: 'Jacob'
  ...
  describe '#create_contact' do
    ...
    it 'passes first_name' do
      expect(result.value!['first_name']).to eql('John')
    end
  end
